...
public:
    ...
    DWORD SetColor(BYTE ucColorIndex, COLORREF crColor, BOOL bRepaint = TRUE);
    DWORD GetColor(BYTE ucColorIndex, COLORREF* crpColor);
    DWORD OffsetColor(BYTE ucColorIndex, short shOffset, BOOL bRepaint = TRUE);

    DWORD SetCheck(int iCheck, BOOL bRepaint = TRUE);
    int   GetCheck();
    ...
    void  SetTooltipText(int iText, BOOL bActivate = TRUE);
    void  SetTooltipText(LPCTSTR lpszText, BOOL bActivate = TRUE);
    void  ActivateTooltip(BOOL bEnable = TRUE);

    DWORD SetBtnCursor(int iCursorId = 0, BOOL bRepaint = TRUE);

    DWORD SetFlat(BOOL bFlat = TRUE, BOOL bRepaint = TRUE);
    DWORD SetAlign(BYTE ucAlign, BOOL bRepaint = TRUE);

    DWORD DrawBorder(BOOL bDrawBorder = TRUE, BOOL bRepaint = TRUE);
    DWORD DrawFlatFocus(BOOL bDrawFlatFocus, BOOL bRepaint = TRUE);

    /* IconIn == IconOut */
    DWORD SetSameIcon(int iIcon);
    DWORD SetIcon(int iIconIn, int iIconOut = 0);
