...
// Construction
public:
    CInPlaceEdit(CWnd* pParent, CRect& rc, DWORD dwStyle, UINT nID,
...
private:
    ...
    BOOL    SpecialChar(UINT nChar);
    BOOL    FindKey(UINT pnKeyArray[], UINT nTarKey, int iKeyNum);
    BOOL    ReturnKeyInit(UINT nChar);
    BOOL    DirectionKeyInit(UINT nChar);
    BOOL    BackKeyInit(UINT nChar);
};
