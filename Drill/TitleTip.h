...
// Operations
public:
    void Show(CRect rcTitle, LPCTSTR lpszTitleText,
              int iXOffset = 0, LPRECT lprcHover = NULL, LPLOGFONT lpLogFont = NULL);
    void Hide();
...
private:
    void MouseBtnDownMessage(MSG* pMsg);
    void KeyDownMessage(MSG* pMsg);
};
